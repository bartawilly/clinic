...
//------------------------------
   ...
   $(document).on("click", "#SBAccounting", function ()
    {
        $(".SBItem").removeClass("active");
        $(this).addClass("active");
	...
	$(document).on("click", "#SBSuccessPassenger", function ()
    {
        $(".SBItem").removeClass("active");
        $(this).addClass("active");
	...
	$(document).on("click", "#SBRoomType", function ()
    {
        $(".SBItem").removeClass("active");
        $(this).addClass("active");
	...
	$(document).on("click", "#SBTaskeen", function ()
    {
        $(".SBItem").removeClass("active");
        $(this).addClass("active");
	...
	$(document).on("click", "#SBSetting", function ()
    {
        $(".SBItem").removeClass("active");
        $(this).addClass("active");
